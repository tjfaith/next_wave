...
import logoLight from "../assets/images/logo/color-logo-no-background.png";
import logoAllDark from "../assets/images/logo/black-logo-no-background.png";
  ...
  render() {
    ...
    return (
      <Fragment>
        ...
        <header className="header-area formobile-menu header--fixed default-color">
          <div className="header-wrapper" id="header-wrapper">
            <div className="header-left">
              <div className="logo">
                <a href="/">
                  <img className="logo-1 w-full h-16" src={logoLight} alt="Logo Images" />
                  <img className="logo-2 w-full h-16" src={logoAllDark} alt="Logo Images" />
                </a>
              </div>
            </div>
        ...
        {/* End Footer Style  */}
        {/* Start Back To Top */}
        <div className="backto-top flex items-center justify-center">
